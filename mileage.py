...
l1.config(bg='sky blue', fg='#123456', font=font)
...
l2.config(bg='sky blue', fg='#123456', font=font)
...
l3.config(bg='sky blue', fg='#123456', font=font)
...
pred.config(bg='powder blue', fg='#123456', font=font)
...
def predict():
    ...
    eb.config(fg='white', bg='cyan', font=('monospace', 25, 'bold'))
